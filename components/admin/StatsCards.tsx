  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-blue-600">{stats.men}</div>
          <p className="text-xs text-muted-foreground">
            Male category designs
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-purple-600">{stats.women}</div>
          <p className="text-xs text-muted-foreground">
            Female category designs
          </p>
        </CardContent>
      </Card>
    </div>
